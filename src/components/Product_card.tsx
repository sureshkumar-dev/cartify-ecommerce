...
const Product_card = ({ img, p_name,  price, seller }: card_props): JSX.Element => {
    return (
        <>
            <motion.div whileHover={{ scale: 1.02 }} className='w-[160px] h-[200px] md:w-[250px] md:h-[370px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white rounded-xl relative overflow-hidden '>
                ...
                <motion.button whileHover={{ cursor: "pointer" }} whileTap={{ y: 4 }} className='py-1 px-2 rounded-[10px] text-[10px] md:text-xl  bg-black absolute right-[10px] bottom-[10px] text-white font-[400]'>Add to Cart</motion.button>
            </motion.div>
        </>
    )
}
